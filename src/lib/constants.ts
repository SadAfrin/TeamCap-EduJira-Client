...
export const ROLE_NAV_ITEMS: Record<Role, NavItem[]> = {
  admin: [
    ...
    { label: "Routine & Timetable", href: "/dashboard/admin/routine", icon: "timetable" },
    { label: "Academic Calendar", href: "/calendar", icon: "calendar" },
  ],
  teacher: [
    { label: "Teacher Dashboard", href: "/teacher", icon: "dashboard" },
    { label: "Mark Attendance", href: "/dashboard/teacher/attendance", icon: "attendance", badge: "Daily" },
